...
//
// Classe que contem uma lista de cursos, com todas informacoes do mesmo. Ao clicar em uma celula,
// haverá uma negavacao com uma tela com mais detalhes sobre o curso
//
//  Created by Guilherme Piccoli on 02/10/19.
